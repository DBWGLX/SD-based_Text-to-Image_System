...
public class AuthController {
    ...
    public Result register(@RequestBody(required = true) Admins admins) {
        Admins admin = adminsService.findByUsername(admins.getUsername());
        if (admin == null) {
            adminsService.register(admins);
