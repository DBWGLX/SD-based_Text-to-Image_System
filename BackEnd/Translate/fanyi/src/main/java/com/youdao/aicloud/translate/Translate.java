...
public class Translate {
    private static final String APP_KEY = "6722af7e43d1600a";     // 您的应用ID
    private static final String APP_SECRET = "fGlAhGEIuOP0wyaDOZHP0W5IfzjSQkIK";  // 您的应用密钥
    public static String use(String p) throws NoSuchAlgorithmException {
        // 添加请求参数
        Map<String, String[]> params = createRequestParams(p);
        // 添加鉴权相关参数
    ...
    private static Map<String, String[]> createRequestParams(String p) {
        /*
